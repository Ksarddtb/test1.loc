                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            ...
                            <div class="form-control-wrap">
                                <input type="text" class="form-control" id="default-01"  wire:model='product.article'  {{ $ProductEdit ? '' :'disabled' }}>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="form-label" for="default-01">Name:*
                                ...
                                @enderror</label>
                            <div class="form-control-wrap">
                                <input type="text" class="form-control" id="default-01"  wire:model='product.name' {{ $ProductEdit ? '' :'disabled' }}>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="form-label" for="default-01">Status:*
                                ...
                                @enderror</label>
                            <div class="form-control-wrap">
                                <select type="text" class="form-control" id="default-01"  wire:model='product.status' {{ $ProductEdit ? '' :'disabled' }}>
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-control-wrap col-md-4">
                                <input type="text" class="form-control" id="default-01"  wire:model='product.data.color' {{ $ProductEdit ? '' :'disabled' }}>
                            </div>
                            <div class="form-control-wrap col-md-4">
                                <input type="text" class="form-control" id="default-02"  wire:model='product.data.size' {{ $ProductEdit ? '' :'disabled' }}>
                            </div>
                            <div class="form-control-wrap col-md-4">
                                <input type="text" class="form-control" id="default-03"  wire:model='product.data.make' {{ $ProductEdit ? '' :'disabled' }}>
                            </div>
                        </div>
                    </div>
                </form>
                <div class="modal-action">
                    <button type="button" class="btn grey btn-success" wire:click='store' {{ $ProductEdit ? '' :'disabled' }}>Сохранит</button>
